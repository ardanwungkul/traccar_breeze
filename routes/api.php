...
Route::post('/devices/devicesById', [TraccarApiController::class, 'devicesById'])->name('api.devicesById');
Route::get('/devices/user/{id}', [TraccarApiController::class, 'devicesByUserId']);
...
Route::get('/modeljson', [TraccarApiController::class, 'getModel']);

Route::post('/permissions', [TraccarApiController::class, 'permissons'])->name('api.permissions');
