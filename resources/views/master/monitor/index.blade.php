<x-app-layout>
    <x-slot name="header">
        <div class=" min-h-[88vh] w-[300px] border-r border-gray-300 bg-white">
            ...
            <form action="{{ route('api.devicesById') }}" method="POST">
                @csrf
                @method('POST')
                                    ...
                                    <div id="accordion-collapse" data-accordion="collapse" class="px-[15px] py-[10px]">
                                        <h2 id="accordion-collapse-heading-1">
                                            <button type="button"
                                                ...
                                                <div>
                                                    <input type="radio" class="hidden" name="user_radio" checked
                                                        id="user-{{ $session->id }}">
                                                    <label for="user-{{ $session->id }}">
                                                        <div class="flex gap-[5px]" style="padding: 0 3px 0 0">
                                                            ...
                                                            <p class="text-[12px]">{{ $session->name }}(0/0)
                                                            </p>
                                                        </div>
                                                    </label>
                                                </div>
                                        ...
                                        <div id="accordion-collapse-body-1" class="hidden"
                                            ...
                                            @foreach ($users as $user)
                                                <div class="flex" style="padding: 10px 0 0 22px">
                                                    <input type="radio" class="hidden" name="user_radio"
                                                        id="user-{{ $user->id }}">
                                            ...
                                            <label for="device-{{ $item->id }}">
                                                <div
                                                    ...
                                                    <div class="flex-none w-1/3">
                                                        <p class="justify-self-end text-end text-xs text-[#666]">
                                                            {{ $result }}
                                                        </p>
                                                    </div>
                                                </div>
            ...
            .then(response => {
                ...
                fetch(deviceApiUrl)
                    ...
                    .then(device => {
                        ...
                        var speed = Math.round(post.speed);
                        ...
                        var customIcon = L.divIcon({
                            ...
                            html: '<img style="width:48px !important;" src="{{ asset('storage/images/icon/car.png') }}" alt="">',
                            iconSize: [24, 24]
                        });
                        ...
                        var popupContent = `<div class=" w-[300px]" style="padding:4px 15px">
                                                ...
                                                <div class="grid grid-cols-2 mb-[10px]">
                                                    <div class="w-[100px] h-[100px] border border-green-500 flex justify-center items-center flex-col">
                                                        <p class="text-4xl text-green-500"> ${speed}</p>
                                                        <p class=" text-gray-600"> km/h</p>
                                                        <p class="text-xl text-green-500"> Moving</p>
        ...
        deviceButtons.forEach(function(button) {
            button.addEventListener("change", function() {
                if (button.checked) {
                    ...
                    var atLeastOneChecked = Array.from(deviceButtons).some(button => button
                        .checked);
